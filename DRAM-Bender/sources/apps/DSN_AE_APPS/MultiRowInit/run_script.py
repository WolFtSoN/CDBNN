...
open_rows_file_name = apps_path + exe_path + "open_rows_t1_10_t2_0_10.txt"

# out_file = apps_path + exe_path + 'multi_row.txt'
out_file = apps_path + exe_path + 'check_row_copy_19_3.txt'
# csv_file = apps_path + exe_path + f'multirow.csv' # f'multirow_{temperature}.csv'
csv_file = apps_path + exe_path + f'check_row_copy_19_3.csv' # f'multirow_{temperature}.csv'
...
or_csv = f'{apps_path}../../../../experimental_data/{module}/open_rows_t1_10_t2_0_10.csv'
...
for rows in [2]: # 2,4,8,16,32
    ...
    #     t_12_lst = [30]
    #     t_23_lst = [1]
    t_12_lst = [10]#[0,10,20,30,40,50,60]
    t_23_lst = [1]#[0,1,2,3,4,5,6]
    # name_t12 = 1
    # name_t23 = 3
    bank_id = 0
    for name_t12 in t_12_lst:
        for name_t23 in t_23_lst:
            sample_csv = f'{apps_path}../../../../experimental_data/{module}/samples_{rows}_stam_{name_t23}.csv'
            ...
            for sample_iter,e_idx in enumerate(samples_df.index):
                ...
                if(os.stat(out_file).st_size != 0):
                    ...
                    temp_data = [[name_t12,name_t23,bank_id,s_id,r_first, r_second, res_lst[0], res_lst[1], res_lst[2]]]
